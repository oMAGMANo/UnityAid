                ...
                if (null != n) {
                    ...
                    try {
                        if (r = (n = n.call(e)).next, 0 === t) {
                            ...
                            for (; !(l = (o = r.call(n)).done) && (a.push(o.value), a.length !== t); l = !0);
                    } catch (e) {
                        u = !0, i = e
                    } finally {
                        try {
        ...
        var d = {
                ...
                if (n) {
                    ...
                    if (o) {
                        ...
                        var r = i.scrollTop,
                            ...
                            a = +new Date;
                        !0 === e ? function e() {
                            var n, o, l, u = +new Date - a,
                                c = (n = u, o = r, l = s, (n /= t / 2) < 1 ? l / 2 * n * n + o : -l / 2 * ((n -= 1) * (n - 2) - 1) + o);
                            i.scrollTop = c, u < t ? requestAnimationFrame(e) : i.scrollTop = s
                        }() : i.scrollTop = s
                    }
                }
            },
            ...
            scrollPageTo: function(e) {
                ...
                var o = n.scrollTop,
                    ...
                    r = +new Date;
                ! function s() {
                    var a, l, u, c = +new Date - r,
                        d = (a = c, l = o, u = i, (a /= t / 2) < 1 ? u / 2 * a * a + l : -u / 2 * ((a -= 1) * (a - 2) - 1) + l);
            ...
            setContentLayout: function() {
                ...
                setTimeout((function() {
                    var n, o = document.querySelector(".content-wrapper > div"),
                        i = document.querySelector(".layout-navbar"),
                    ...
                    })) && (e._removeClass("container-fluid", [o, l]), e._addClass("container-xxl", [o, l])), a && (e._removeClass("container-fluid", [a]), e._addClass("container-xxl", [a])), d && u.some((function(e) {
                        return [i].includes(e)
                    })) && (e._removeClass("container-fluid", [i]), e._addClass("container-xxl", [i])), f && (e._removeClass("container-fluid", n), e._addClass("container-xxl", n), r && (e._removeClass("container-fluid", r), e._addClass("container-xxl", r)), s && (e._removeClass("container-fluid", s), e._addClass("container-xxl", s)))) : (c.some((function(e) {
                        return [o, l].includes(e)
                    })) && (e._removeClass("container-xxl", [o, l]), e._addClass("container-fluid", [o, l])), a && (e._removeClass("container-xxl", [a]), e._addClass("container-fluid", [a])), d && c.some((function(e) {
                        return [i].includes(e)
                    })) && (e._removeClass("container-xxl", [i]), e._addClass("container-fluid", [i])), f && (e._removeClass("container-xxl", n), e._addClass("container-fluid", n), r && (e._removeClass("container-xxl", r), e._addClass("container-fluid", r)), s && (e._removeClass("container-xxl", s), e._addClass("container-fluid", s))))
                }), 500)
            },
            update: function() {
            ...
            initPasswordToggle: function() {
                ...
                null != e && e.forEach((function(e) {
                    e.addEventListener("click", (function(t) {
                        ...
                        "text" === i.getAttribute("type") ? (i.setAttribute("type", "password"), o.classList.replace("la-eye", "la-eye-slash")) : "password" === i.getAttribute("type") && (i.setAttribute("type", "text"), o.classList.replace("la-eye-slash", "la-eye"))
                    }))
                }))
            },

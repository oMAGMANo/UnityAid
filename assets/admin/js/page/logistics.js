...
!(function () {
    let e, t;
    var s = {
            donut: { series1: config.colors.success, series2: "rgba(113, 221, 55, 0.6)", series3: "rgba(113, 221, 55, 0.4)", series4: "rgba(113, 221, 55, 0.2)" },
        ...
        r = {
            series: [
                { name: "Deposit", type: "column", data: [38, 45, 33, 38, 32, 50, 48, 40, 42, 37] },
                { name: "Withdraw", type: "line", data: [23, 28, 23, 32, 28, 44, 32, 38, 26, 34] },
            ],
            ...
            (e.DataTable({
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        render: function (e, t, s, a) {
                            return (
                                '<div class="d-flex justify-content-start align-items-center user-name"><div class="avatar-wrapper"><div class="avatar me-2"><span class="avatar-initial rounded-circle bg-label-secondary"><i class="bx bxs-truck"></i></span></div></div><div class="d-flex flex-column"><a class="text-body fw-medium" href="app-logistics-fleet.html">VOL-' +
                                s.location +
                                "</a></div></div>"
                            );
                        },

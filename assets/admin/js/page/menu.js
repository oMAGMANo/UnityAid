        ...
        var s = ["transitionend", "webkitTransitionEnd", "oTransitionEnd"],
            l = function() {
                function e(n) {
                    ...
                    for (var l = n.classList, r = 0; r < l.length; r++) l[r].startsWith("bg-") && (this._menuBgClass = l[r]);
                    n.setAttribute("data-bg-class", this._menuBgClass), this._bindEvents(), n.menuInstance = this
                }
                var n, t, l;
                return n = e, l = [{
                    key: "childOf",
                    ...
                    value: function(e, n) {
                        ...
                        for (e = e.parentNode;
                            "BODY" !== e.tagName.toUpperCase() && !e.classList.contains(n);) e = e.parentNode;
                        if (!(e = "BODY" !== e.tagName.toUpperCase() ? e : null) && t) throw new Error("Cannot find `.".concat(n, "` parent element"));
                        return e
                    }
                }, {
                    key: "_findChild",
                    value: function(e, n) {
                        for (var t = e.childNodes, i = [], o = 0, s = t.length; o < s; o++)
                            if (t[o].classList) {
                                for (var l = 0, r = 0; r < n.length; r++) t[o].classList.contains(n[r]) && (l += 1);
                    ...
                    key: "_findMenu",
                    value: function(e) {
                        for (var n = e.childNodes[0], t = null; n && !t;) n.classList && n.classList.contains("menu-sub") && (t = n), n = n.nextSibling;
                        if (!t) throw new Error("Cannot find `.menu-sub` element for the current `.menu-toggle`");
                        return t
                    }
                }, {
                    key: "_hasClass",
                    ...
                    value: function(n, t) {
                        ...
                        if (n.classList.contains("menu-item") ? e._findChild(n, [o]).length && (i = n) : n.classList.contains(o) && (i = n.parentNode.classList.contains("menu-item") ? n.parentNode : null), !i) throw new Error("".concat(t ? "Toggable " : "", "`.menu-item` element not found."));
                        return i
                    }
                }, {
                    key: "_getLink",
                    value: function(n, t) {
                        var i = [],
                            o = t ? "menu-toggle" : "menu-link";
                        if (n.classList.contains(o) ? i = [n] : n.classList.contains("menu-item") && (i = e._findChild(n, [o])), !i.length) throw new Error("`".concat(o, "` element not found."));
                        return i[0]
                    }
                }, {
                    ...
                    value: function(n, t) {
                        ...
                        o = parseFloat(o) * (-1 !== o.indexOf("ms") ? 1 : 1e3), n._menuAnimationEndEventCb = i, s.forEach((function(e) {
                    ...
                    value: function(e) {
                        ...
                        e._menuAnimationEndEventTimeout && (clearTimeout(e._menuAnimationEndEventTimeout), e._menuAnimationEndEventTimeout = null), n && (s.forEach((function(t) {
                    ...
                    value: function() {
                        ...
                        this._evntElClick = function(t) {
                            ...
                            o && (t.preventDefault(), "true" !== o.getAttribute("data-hover") && n.toggle(o))
                        }, window.Helpers.isMobileDevice && this._el.addEventListener("click", this._evntElClick), this._evntWindowResize = function() {
                            n.update(), n._lastWidth !== window.innerWidth && (n._lastWidth = window.innerWidth, n.update());
                    ...
                    value: function(n) {
                        ...
                        if (o) {
                            ...
                            e._promisify(this._onOpen, this, o, s, e._findMenu(o)).then((function() {
                                ...
                                })), t._accordion && t._closeOther(o, i)) : t._animate ? t._onOpened && t._onOpened(t, o, s, e._findMenu(o)) : (o.classList.add("open"), t._onOpened && t._onOpened(t, o, s, e._findMenu(o)), t._accordion && t._closeOther(o, i))
                            })).catch((function() {}))
                        }
                    }
                }, {
                    ...
                    value: function(n) {
                        ...
                        s.classList.contains("open") && !s.classList.contains("disabled") && e._promisify(this._onClose, this, s, l, e._findMenu(s), o).then((function() {
                            if (t._horizontal && e._isRoot(s)) t._onClosed && t._onClosed(t, s, l, e._findMenu(s));
                            else if (t._animate && !t._horizontal) window.requestAnimationFrame((function() {
                                return t._toggleAnimation(!1, s, i)
                            }));
                            else {
                                if (s.classList.remove("open"), i)
                                    for (var n = s.querySelectorAll(".menu-item.open"), o = 0, r = n.length; o < r; o++) n[o].classList.remove("open");
                    ...
                    key: "_closeOther",
                    value: function(n, t) {
                        for (var i = e._findChild(n.parentNode, ["menu-item", "open"]), o = 0, s = i.length; o < s; o++) i[o] !== n && this.close(i[o], t)
                    }
                }, {
                    key: "toggle",
                    value: function(n) {
                    ...
                    value: function(n, t) {
                        for (var i = [], o = null; n;) n.classList.contains("disabled") ? (o = null, i = []) : (n.classList.contains("open") || (o = n), i.push(n)), n = e._findParent(n, "menu-item", !1);
                        if (!o) return null;
                            ...
                            if (i[s].classList.add("open"), this._accordion)
                                for (var r = e._findChild(i[s].parentNode, ["menu-item", "open"]), a = 0, u = r.length; a < u; a++)
                                    if (r[a] !== i[s] && (r[a].classList.remove("open"), t))
                                        for (var c = r[a].querySelectorAll(".menu-item.open"), d = 0, h = c.length; d < h; d++) c[d].classList.remove("open");
                        return o
                    }
                }, {
                    ...
                    value: function(n, t, i) {
                        ...
                        var a = function() {
                            t.classList.remove("menu-item-animating"), t.classList.remove("menu-item-closing"), t.style.overflow = null, t.style.height = null, o.update()
                        };
                        n ? (t.style.height = "".concat(r, "px"), t.classList.add("menu-item-animating"), t.classList.add("open"), e._bindAnimationEndEvent(t, (function() {
                            a(), o._onOpened(o, t, s, l)
                        })), setTimeout((function() {
                            t.style.height = "".concat(r + Math.round(l.getBoundingClientRect().height), "px")
                        }), 50)) : (t.style.height = "".concat(r + Math.round(l.getBoundingClientRect().height), "px"), t.classList.add("menu-item-animating"), t.classList.add("menu-item-closing"), e._bindAnimationEndEvent(t, (function() {
                            if (t.classList.remove("open"), a(), i)
                                for (var e = t.querySelectorAll(".menu-item.open"), n = 0, r = e.length; n < r; n++) e[n].classList.remove("open");
                            o._onClosed(o, t, s, l)
                        })), setTimeout((function() {
                    ...
                    key: "closeAll",
                    value: function() {
                        for (var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this._closeChildren, n = this._el.querySelectorAll(".menu-inner > .menu-item.open"), t = 0, i = n.length; t < i; t++) this.close(n[t], e)
                    }
                }, {
                    key: "update",
                    value: function() {
                    ...
                    value: function() {
                        ...
                        if (window.innerWidth < window.Helpers.LAYOUT_BREAKPOINT) null !== this._scrollbar && (this._scrollbar.destroy(), this._scrollbar = null), n.classList.add("overflow-auto");
                        else {
                    ...
                    value: function() {
                        if (this._el) {
                            this._unbindEvents();
                            for (var n = this._el.querySelectorAll(".menu-item"), t = 0, i = n.length; t < i; t++) e._unbindAnimationEndEvent(n[t]), n[t].classList.remove("menu-item-animating"), n[t].classList.remove("open"), n[t].style.overflow = null, n[t].style.height = null;
                            for (var o = this._el.querySelectorAll(".menu-menu"), s = 0, l = o.length; s < l; s++) o[s].style.marginRight = null, o[s].style.marginLeft = null;
                ...
                }]) && o(n.prototype, t), l && o(n, l), Object.defineProperty(n, "prototype", {
                    writable: !1
                }), e
            }()
    }

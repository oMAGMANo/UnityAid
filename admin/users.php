												...
												<tbody class="table-border-bottom-0">
												    <?php
	                                                     ...
	                                                     if(!empty($_GET['search'])){
	                                                         $sql .= " and username like '%".$_GET['search']."%'";
	                                                     }
													...
													<tr>
														<td>
															<div> <span class="fw-bold"><?=$row['name']?></span> <br> <span class="small">
                                                                  <a href="user-details.php?uid=<?=$row['id']?>"><span>@</span><?=$row['username']?></a>
																</span>
															</div>
														</td>
														<td>
														...
														<td>
															<a href="user-details.php?uid=<?=$row['id']?>" class="btn btn-sm btn-label-info"> <span class="tf-icons las la-info-circle me-1"></span> Details </a>
														    <button type="button" class="btn btn-sm btn-label-danger decisionBtn" data-question="Are you sure to Delete this User?" data-action="<?=$row['id']?>"> <span class="tf-icons las la-ban me-1"></span> Delete </button>
														</td>
													</tr>
													<?php } } ?>

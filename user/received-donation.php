					...
					<div class="row justify-content-center">
						<div class="col-lg-8">
							<div class="breadcrumb__wrapper">
								<h1 class="breadcrumb__title"> Donations</h1>
						...
						<div class="card-body">
							<div class="d-flex justify-content-end mb-3">
								<form action="" method="GET" class="input--group">
									<input type="text" class="form--control" name="search" value="" placeholder="Search by transaction">
							...
							<table class="table table-striped table-borderless table--responsive--xl">
								...
								<tbody>
								    <?php
	                                 $sql = "select * from donation where organizer_id='".$_SESSION["login_id"]."'";
									...
									<tr>
										...
										<td> <span class="text--base"><?=$row['txn_id']?></span></td>
										<td> <?=date("d-m-Y h:i A", strtotime($row['created_date'])) ?></td>
										<td><strong><?=$row['amount']?></strong> </td>
										<td><a href="../uploads/<?=$row['attachment']?>" class="btn btn-sm btn--icon btn--base"><i class="fa-regular fa-eye"></i></a>  </td>
										<td> 
										<?php if($row['status']==0){
